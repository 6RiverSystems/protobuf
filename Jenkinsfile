        ...
        node('docker && amd64') {
          ...
          try {
            stage("Build Docker Image") {
                ...
                customImage = docker.build("gcr.io/plasma-column-128721/protobuf-builder-melodic:amd64", " --file 6river-melodic-amd64.dockerfile ." )
            }
        ...
        node('docker && amd64') {
          ...
          try {
            stage("Build Docker Image") {
                ...
                customImage = docker.build("gcr.io/plasma-column-128721/protobuf-builder-kinetic:amd64", " --file 6river-kinetic-amd64.dockerfile ." )
            }
            stage("Build and Publish") {
              customImage.inside("-u 0:0 -e GIT_BRANCH=${scmVars.GIT_BRANCH}") {
                withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: 'artifactory_apt',
        ...
        node('docker && arm64') {
          ...
          try {
            stage("Build Docker Image") {
                ...
                customImage = docker.build("gcr.io/plasma-column-128721/protobuf-builder-melodic:arm64", " --file 6river-melodic-arm64.dockerfile ." )
            }
            stage("Build and Publish") {
              customImage.inside("-u 0:0 -e GIT_BRANCH=${scmVars.GIT_BRANCH}") {
                withCredentials([string(credentialsId: 'github-access-token', variable: 'GITHUB_TOKEN')]) {
        ...
        node('docker && arm64') {
          ...
          try {
            stage("Build Docker Image") {
                ...
                customImage = docker.build("gcr.io/plasma-column-128721/protobuf-builder-kinetic:arm64", " --file 6river-kinetic-arm64.dockerfile ." )
            }
            stage("Build and Publish") {
              customImage.inside("-u 0:0 -e GIT_BRANCH=${scmVars.GIT_BRANCH}") {
                withCredentials([string(credentialsId: 'github-access-token', variable: 'GITHUB_TOKEN')]) {
